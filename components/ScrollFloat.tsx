...
const ScrollFloat = ({
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      {
        duration: animationDuration, ease: ease, opacity: 1, yPercent: 0, scaleY: 1, scaleX: 1, stagger: stagger,
  ...
  return (
    <h2 ref={containerRef} className={`my-5 overflow-visible ${containerClassName}`}>
